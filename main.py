...
if __name__ == "__main__":
    g=GPS()
    m = mail.Mail("besoin soin","besoin visite") 
    hc = collectheart.sendFrequence()
    hc.start()
    m.start()
    ...
    while True:
	    ...
	    data = {"entry.141408963":lat,"entry.712637557":longitude} 
	    requests.post("https://docs.google.com/forms/d/1tsbtQ15pXh_mxGDq5NM00YtFveQiB4Gfah-N1dun85w/formResponse?", data = data)
	    dweepy.dweet_for('fasogpsdata',{'alti':alt,'longi':longitude})
            try:
